...
export default function ArchitectureDiagram() {
  const pipelineNodes = [
    {
      ...
      tech: "Sentinel-2 (MSI) + Landsat 8/9 (OLI)",
      desc: "Calibrated Level-2A surface reflectance optical bands (B4, B8, B11, B12).",
    ...
    },
    {
      ...
      desc: "Pixel-wise differential computation across NDVI, NDBI, and brightness indexes.",
    ...
    },
    {
      ...
      desc: "Boundary masking, noise filtering, and polygonization into discrete vector change zones.",
    ...
    },
    {
      ...
      desc: "Coordinates spatial queries, status transitions, and data delivery to the frontend.",
  ...
  return (
    <section id="architecture" className="py-24 bg-[#080c14] border-b border-slate-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {pipelineNodes.map((node, index) => (
            <div key={node.id}>
              <div className="p-5 rounded-xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-colors flex items-start gap-4">
