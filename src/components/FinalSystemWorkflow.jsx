...
export default function FinalSystemWorkflow() {
  ...
  return (
    <section id="final-workflow" className="py-24 bg-[#080c14] border-b border-slate-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Operational Note */}
        <div className="mb-12 p-4 rounded-lg bg-slate-900/60 border border-slate-800 text-xs text-slate-300 font-sans space-y-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {workflowNodes.map((node) => (
            <div
              key={node.num}
              className="p-5 rounded-xl bg-slate-900/50 border border-slate-800/80 hover:border-slate-700 transition-colors flex flex-col justify-between"
            >
              <div>
