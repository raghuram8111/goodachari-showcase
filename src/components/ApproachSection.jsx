...
export default function ApproachSection() {
  ...
  return (
    <section id="approach" className="py-24 bg-[#080c14] border-b border-slate-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 p-4 rounded-lg bg-cyan-950/20 border border-cyan-500/30 flex items-start gap-3">
          ...
          <div className="space-y-1 text-xs">
            ...
            <p className="text-slate-300 leading-relaxed font-sans">
              This diagram represents the broader <strong>Final Solution</strong> for full-scale government deployment. What has been concretely executed in our working proof-of-concept is detailed separately in the <strong>Current Prototype</strong> section below.
            </p>
          </div>
        </div>
          ...
          {FINAL_SOLUTION_CONCEPT_STEPS.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-[11px] text-slate-400 leading-relaxed pt-3 border-t border-slate-800/80 font-sans mt-3">
                  {item.desc}
                </p>
              </div>
            );
