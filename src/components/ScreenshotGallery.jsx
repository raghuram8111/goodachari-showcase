...
function PlaceholderGraphic({ file, title }) {
  return (
    <div className="w-full h-full p-5 flex flex-col justify-between bg-slate-950 font-mono text-xs border-b border-slate-800">
      <div className="flex items-center justify-between text-[11px] text-slate-400">
        <span className="uppercase tracking-wider font-semibold text-slate-300">{title}</span>
        <span className="text-slate-500">PROTOTYPE VIEW</span>
      </div>
      ...
      <div className="my-auto text-center space-y-2 py-4">
        ...
        <div className="text-[10px] text-cyan-400 bg-slate-900 px-2 py-1 rounded inline-block border border-slate-800">
...
export default function ScreenshotGallery() {
  ...
  return (
    <section id="screenshots" className="py-24 bg-[#0a0e17] border-b border-slate-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Verification Note */}
        <div className="mb-12 p-4 rounded-lg bg-slate-900/60 border border-slate-800 flex items-start gap-3">
          ...
          {SCREENSHOTS.map((item) => {
            ...
            return (
              <div
                ...
                className="group cursor-pointer rounded-xl bg-slate-900/50 border border-slate-800 hover:border-cyan-500/50 transition-all overflow-hidden flex flex-col"
              >
                ...
                <div className="relative aspect-[16/10] bg-slate-950 overflow-hidden flex items-center justify-center">
                  ...
                  {/* Category Pill */}
                  <span className="absolute top-3 left-3 px-2 py-0.5 rounded bg-slate-900/90 text-[10px] font-mono text-cyan-300 border border-slate-700/60">
                    {item.category}
                  </span>
                </div>
